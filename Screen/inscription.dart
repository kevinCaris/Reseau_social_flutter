...
class _inscriptionState extends State<inscription> {
  ...
  final TextEditingController _nom_prenomController = TextEditingController();
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                    controller: _nom_prenomController,
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate() && isAccepted) {
                      ...
                      String nom_prenom = _nom_prenomController.text;
                      String email = _emailController.text;
                      String password = _passwordController.text;
                      print('Nom prenom: $nom_prenom');
                      print('Email: $email');
